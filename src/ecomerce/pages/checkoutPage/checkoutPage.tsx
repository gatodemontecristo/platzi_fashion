...
export const CheckoutPage = () => {
  ...
  return (
        ...
        <div className="flex flex-col gap-8 lg:w-[60%] w-full md:p-4 p-1">
          <div className="flex lg:hidden flex-col w-full gap-2">
            <div className="flex flex-row justify-end">
              <button
                onClick={toggleOrder}
                className="p-2 border rounded-lg transition-colors duration-300 border-gray-300 bg-white"
              >
    ...
    disabled:bg-gray-400 disabled:text-white  disabled:cursor-not-allowed disabled:transform-none"
        ...
        <div className="lg:flex hidden flex-col gap-4 w-[40%] py-4 pr-4 pl-8 border-l  border-gray-200 ">
          <p>Order Summary</p>
